========================================================================
    控制台应用程序：PEImporterTest 项目概述
========================================================================

应用程序向导已为您创建了此 PEImporterTest 应用程序。

本文件概要介绍组成 PEImporterTest 应用程序的每个文件的内容。


PEImporterTest.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 
    的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

PEImporterTest.vcxproj.filters
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 PEImporterTest.pch 的预编译头 (PCH) 文件和
