...
static int get_ue(GetBitContext *s, char *file, char *func, int line){
...
static int get_se(GetBitContext *s, char *file, char *func, int line){
    int show= show_bits(s, 24);
    int pos= get_bits_count(s);
...
static int get_te(GetBitContext *s, int r, char *file, char *func, int line){
    int show= show_bits(s, 24);
    int pos= get_bits_count(s);
 ...
 */
//atic inline void set_se_golomb(PutBitContext *pb, int i){
 ...
 */
//atic inline void set_ur_golomb(PutBitContext *pb, int i, int k, int limit, int esc_len){
 ...
 */
//atic inline void set_ur_golomb_jpegls(PutBitContext *pb, int i, int k, int limit, int esc_len){
