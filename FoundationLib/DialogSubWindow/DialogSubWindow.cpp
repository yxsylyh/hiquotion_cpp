...
CDialogSubWindow::CDialogSubWindow(UINT nIDTemplate, CWnd* pParentWnd /*= NULL*/)
...
void CDialogSubWindow::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDialogSubWindow, CDialog)
...
HBRUSH CDialogSubWindow::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
BOOL CDialogSubWindow::OnEraseBkgnd(CDC* pDC) 
{
...
void CDialogSubWindow::setBackColor( COLORREF val )
{
	m_backColor=val;
	m_backColorBrush.CreateSolidBrush(m_backColor);
}

void CDialogSubWindow::setSelectedBackColor( COLORREF val )
{
