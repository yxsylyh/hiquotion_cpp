...
#include <C++\3rdParty\TinyXml\tinyxml.h>
#include <string>
using namespace std;
...
public:
	...
	// 获取指定节点的文本
	string getElementText(TiXmlElement *element);
	// 获取指定节点的指定属性名称的属性值
	string getElementAttribute(TiXmlElement *element,string propertyName);
