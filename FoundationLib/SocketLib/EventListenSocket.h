...
class CEventListenSocket : public CSocket, public IEventRaisable, public IEventHandler
{
// Attributes
public:
...
public:
	CEventListenSocket();
	virtual ~CEventListenSocket();

	BOOL getAccept() const { return m_isAccept; }
	CEventSocket &getSocket();
