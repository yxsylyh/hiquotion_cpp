// RE2SGConverter.cpp: implementation of the CRE2SGConverter class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "RE2SGConverter.h"
...
CRE2SGConverter::CRE2SGConverter()
{
...
CRE2SGConverter::~CRE2SGConverter()
{
	...
	CStatusGraphic *CRE2SGConverter::genFromEmptyRE(CEmptyRegularExpression *re)
	{
		if(!re)
			return NULL;
...
// 		arc->setNodeEnd(graphic->getEndNode());
	...
	CStatusGraphic *CRE2SGConverter::genFromRangeRE(CRangeRegularExpression *re)
	{
		if(!re)
			return NULL;
...
// 		arc->setNodeEnd(graphic->getEndNode());
	...
	CStatusGraphic *CRE2SGConverter::genFromSymbolRE(CSymbolRegularExpression *re)
	{
		if(!re)
			return NULL;
...
// 		arc->setNodeEnd(graphic->getEndNode());
	...
	CStatusGraphic *CRE2SGConverter::genFromConcatRE(CConcatRegularExpression *re)
	{
		if(!re)
			return NULL;
...
// 		delete sg2;
	...
	CStatusGraphic *CRE2SGConverter::genFromOrRE(COrRegularExpression *re)
	{
		if(!re)
			return NULL;
...
// 		delete sg2;
	...
	CStatusGraphic *CRE2SGConverter::genFromKleenStarRE(CKleenStarRegularExpression *re)
	{
		CStatusGraphic *graphic=new CStatusGraphic();
